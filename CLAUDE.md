# At Fielt Trimble Connect extensie — Project Upload

Deze extensie laat gebruikers bestanden uploaden naar Trimble Connect met een wachtrij en voortgangsindicator, waarbij alleen mappen met schrijfrechten getoond worden. Geïntegreerd met de At Fielt Extension Hub voor toegangscontrole en usage-tracking.
...
- **Slug in hub-database**: `project-upload`
- **GitHub repo**: Tomtietom/trimble-project-upload
- **Manifest URL**: https://tomtietom.github.io/trimble-project-upload/
...
- **Bijzonderheid**: roept Trimble API direct aan (geen proxy); gebruikt XHR voor uploads met voortgang.
...
**Niet verwijderen of omzeilen.** JWT-tokens verlopen na ~1-2 uur; zonder deze helpers hangen calls als het paneel lang open staat. Ook de XHR-upload-call roept `_ensureValidToken()` aan vóór elke upload zodat het token vers is bij grote bestanden.
